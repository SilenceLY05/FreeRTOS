...
static TaskHandle_t LED1_Task_Handle = NULL;/* Take_Task任务句柄 */
static TaskHandle_t LED2_Task_Handle = NULL;/* Take_Task任务句柄 */
static TaskHandle_t CPU_Task_Handle = NULL;/* Give_Task任务句柄 */
