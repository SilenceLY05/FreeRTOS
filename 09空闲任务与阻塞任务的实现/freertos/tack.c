...
void vTaskSwitchContext(void)
{
	...
	{
		if(Task1TCB.xTicksToDelya == 0)
		{
			pxCurrentTCB = &Task1TCB;
		}
		else if(Task2TCB.xTicksToDelya == 0)
		{
			pxCurrentTCB = &Task2TCB;
		}
		else
	...
	else
	{
		...
		if(pxCurrentTCB == &Task1TCB)
		{
			if(Task2TCB.xTicksToDelya == 0)
			{
				pxCurrentTCB = &Task2TCB;
			}
			else if( pxCurrentTCB->xTicksToDelya != 0)
			{
...
void vTaskDelay(const TickType_t xTicksToDelay)
{
	...
	/* 设置延时时间 */
	pxTCB->xTicksToDelya = xTicksToDelay;
